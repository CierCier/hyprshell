...
Item {
    ...
    property Item layoutBounds: null
    ...
    Row {
        ...
        anchors {
            top: layoutBounds ? layoutBounds.top : parent.top
            left: layoutBounds ? layoutBounds.left : parent.left
    ...
    Row {
        ...
        anchors {
            top: layoutBounds ? layoutBounds.top : parent.top
            horizontalCenter: layoutBounds ? layoutBounds.horizontalCenter : parent.horizontalCenter
            topMargin: Config.menuAreaButtonsMarginTop
        }
    }
    ...
    Row {
        ...
        anchors {
            top: layoutBounds ? layoutBounds.top : parent.top
            right: layoutBounds ? layoutBounds.right : parent.right
            topMargin: Config.menuAreaButtonsMarginTop
    ...
    Column {
        ...
        anchors {
            left: layoutBounds ? layoutBounds.left : parent.left
            verticalCenter: layoutBounds ? layoutBounds.verticalCenter : parent.verticalCenter
            leftMargin: Config.menuAreaButtonsMarginLeft
        }
    }
    ...
    Row {
        ...
        anchors {
            bottom: layoutBounds ? layoutBounds.bottom : parent.bottom
            left: layoutBounds ? layoutBounds.left : parent.left
