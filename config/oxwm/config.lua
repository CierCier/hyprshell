...
local bar_font = "JetBrainsMono NFP:style=Bold:size=10"
...
oxwm.autostart("feh --bg-scale ~/Pictures/Wallpapers/arknights/Breakthrough.png") 
oxwm.autostart("dunst")
oxwm.autostart("nm-applet")
oxwm.autostart("clipse -listen")
