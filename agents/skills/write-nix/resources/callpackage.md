...
> Source: https://nix.dev/tutorials/callpackage.html
> Upstream: https://github.com/nixos/nix.dev (`source/tutorials/callpackage.md`)
> Authors: NobbZ; Editors: mmesch, fricklerhandwerk
...
- First experience with [packaging existing software](https://nix.dev/tutorials/packaging-existing-software.html)
...
- [Working with local files](https://nix.dev/tutorials/working-with-local-files.html) - learn to package your own projects with Nix
- [NixOS module system deep dive](https://nix.dev/tutorials/module-system/deep-dive.html) - learn to wield the functional programming magic behind NixOS
