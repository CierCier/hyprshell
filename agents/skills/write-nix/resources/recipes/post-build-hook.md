...
> Source: https://nix.dev/guides/recipes/post-build-hook.html
> Upstream: https://github.com/nixos/nix.dev (`source/guides/recipes/post-build-hook.md`)
...
Configure [a custom binary cache](./add-binary-cache.md) on any machine that will access the bucket.
...
Before deploying this to production, be sure to consider the implementation caveats above.
