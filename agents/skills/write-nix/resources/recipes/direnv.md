...
> Source: https://nix.dev/guides/recipes/direnv.html
> Upstream: https://github.com/nixos/nix.dev (`source/guides/recipes/direnv.md`)

Instead of manually activating the environment for each project, you can reload a [declarative shell](https://nix.dev/tutorials/first-steps/declarative-shell.html) every time you enter the project's directory or change the `shell.nix` inside it.
