...
> Source: https://nix.dev/tutorials/nixos/binary-cache-setup.html
> Upstream: https://github.com/nixos/nix.dev (`source/tutorials/nixos/binary-cache-setup.md`)
...
- SSH access to a NixOS machine to use as a cache
  ...
  If you're new to NixOS, learn about the [module system](https://nix.dev/tutorials/module-system/) and configure your first system with [NixOS virtual machines](https://nix.dev/tutorials/nixos/nixos-configuration-on-vm.html).
...
- (optional) A public IP and DNS domain
  ...
  Follow the tutorial on [Provisioning remote machines via SSH](https://nix.dev/tutorials/nixos/provisioning-remote-machines.html) to deploy your NixOS configuration.
...
> **Important:**
There is an [optional HTTPS section](https://nix.dev/tutorials/nixos/binary-cache-setup.html) at the end of this tutorial.
...
> **Important:**
[Configure Nix to use a custom binary cache](https://nix.dev/guides/recipes/add-binary-cache.html) using `cache-public-key.pem` on your local machine.
...
- [Configure Nix to use a custom binary cache](https://nix.dev/guides/recipes/add-binary-cache.html) using the binary cache's hostname and the generated public key
- [Setting up post-build hooks](https://nix.dev/guides/recipes/post-build-hook.html) to upload store objects to the binary cache
- [Setting up distributed builds](https://nix.dev/tutorials/nixos/distributed-builds-setup.html)
