...
> Source: https://nix.dev/tutorials/nixos/provisioning-remote-machines.html
> Upstream: https://github.com/nixos/nix.dev (`source/tutorials/nixos/provisioning-remote-machines.md`)
...
The *local machine* only needs a working [Nix installation](https://nix.dev/install-nix.html).
...
[Specify dependencies](https://nix.dev/guides/recipes/dependency-management.html) on `nixpkgs`, `disko`, and `nixos-anywhere`:
...
- [Setting up a binary cache](https://nix.dev/tutorials/nixos/binary-cache-setup.html)
- [Setting up post-build hooks](https://nix.dev/guides/recipes/post-build-hook.html)
