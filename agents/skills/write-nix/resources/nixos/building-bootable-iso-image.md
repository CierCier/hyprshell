...
> Source: https://nix.dev/tutorials/nixos/building-bootable-iso-image.html
> Upstream: https://github.com/nixos/nix.dev (`source/tutorials/nixos/building-bootable-iso-image.md`)
> Authors: domenkozar
