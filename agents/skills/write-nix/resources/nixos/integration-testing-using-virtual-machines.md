...
> Source: https://nix.dev/tutorials/nixos/integration-testing-using-virtual-machines.html
> Upstream: https://github.com/nixos/nix.dev (`source/tutorials/nixos/integration-testing-using-virtual-machines.md`)
...
- A working Nix installation on Linux, or [NixOS](https://nixos.org/manual/nixos/stable/index.html#sec-installation)
...
1. Use a [pinned version of Nixpkgs](https://nix.dev/tutorials/first-steps/towards-reproducibility-pinning-nixpkgs.html), and explicitly set configuration options and overlays to avoid them being inadvertently overridden by global configuration:
...
1. Because this example only uses one virtual machine, the node we specify is simply called `machine`.
   ...
   As configuration you use the relevant parts of the default configuration, which we used in a previous tutorial:
...
- [Building and running Docker images](https://nix.dev/tutorials/nixos/building-and-running-docker-images.html)
