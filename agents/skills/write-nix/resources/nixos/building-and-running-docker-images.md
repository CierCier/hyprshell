...
> Source: https://nix.dev/tutorials/nixos/building-and-running-docker-images.html
> Upstream: https://github.com/nixos/nix.dev (`source/tutorials/nixos/building-and-running-docker-images.md`)
> Authors: domenkozar
...
- [Set up a remote build machine](https://nix.dev/tutorials/nixos/distributed-builds-setup.html) to build on Linux
- [Cross compile to Linux](https://nix.dev/tutorials/cross-compilation.html) by replacing `pkgsLinux.hello` with `pkgs.pkgsCross.musl64.hello`
