...
> Source: https://nix.dev/tutorials/nixos/installing-nixos-on-a-raspberry-pi.html
> Upstream: https://github.com/nixos/nix.dev (`source/tutorials/nixos/installing-nixos-on-a-raspberry-pi.md`)
> Authors: domenkozar; Editors: proofconstruction
...
- To enable hardware acceleration for a nice graphical desktop experience, add the [`nixos-hardware`](https://github.com/nixos/nixos-hardware) module to your configuration:
  ...
  We recommend pinning the reference to `nixos-hardware`: [Towards reproducibility: pinning Nixpkgs](https://nix.dev/tutorials/first-steps/towards-reproducibility-pinning-nixpkgs.html)
